...
export function CTA() {
  return (
    <section id="cta" className="max-w-[1440px] mx-auto p-8 max-h-[644px]">
      <div className="bg-white rounded-4xl p-10 flex gap-10 items-center">
        <div className="flex flex-col">
          ...
          <motion.p
            ...
            className="mt-6 text-lg md:text-body text-[#71717A] leading-relaxed md:leading-relaxed"
          >
