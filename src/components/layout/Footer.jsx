  ...
  return (
    <footer className="bg-white">
      <div className="border-y border-[#EDEDED]">
        <div className="container grid grid-cols-3 border-x divide-x divide-[#E4E4E7] border-[#E4E4E7] bg-white w-full">
          <div className="col-span-3 py-8 px-10 flex justify-between items-center border-b border-[#E4E4E7]">
            <div className="max-w-md">
              ...
              <p className="mt-1.5 text-sm text-[#71717A]">
                Get the latest product updates, ecosystem news, and insights on
                real-time AI payments delivered to your inbox.
              </p>
            </div>

            <div className="relative w-[500px] h-14">
              <input
                type="email"
      ...
      transition-colors hover:bg-[#FFFFFF]"
          ...
          <div className="p-10">
            ...
            <ul className="space-y-4 text-sm text-[#09090B] mt-6">
              <li>
          ...
          {/* FOOTER */}
          <div className="col-span-3 border-t flex justify-between border-[#E4E4E7] py-6 px-10">
